...
public abstract class AbstractJoinComputeJob extends ComputeJobAdapter {
    ...
    protected String cacheNameA;

    protected String cacheNameB;
    ...
    protected List<BinaryObject> scanRightCache(
        ...
        log.debug(
            logPrefix + "Job [" + jobId + "] loads " + binaryObjects.size() + " entries of " + cacheNameB + " cache");
